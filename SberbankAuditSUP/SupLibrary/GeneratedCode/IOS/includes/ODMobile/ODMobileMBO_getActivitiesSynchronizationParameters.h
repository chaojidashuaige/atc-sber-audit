...
/*!
 @class ODMobileMBO_getActivitiesSynchronizationParameters
...
@interface ODMobileMBO_getActivitiesSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getActivitiesSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBO_getActivitiesSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getActivitiesSynchronizationParameters(internal)
