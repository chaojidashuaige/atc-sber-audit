...
/*!
 @class ODMobileMBOUnions_pull_pq
...
@interface ODMobileMBOUnions_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOUnions_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOUnions_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOUnions_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOUnions_pull_pq(internal)
