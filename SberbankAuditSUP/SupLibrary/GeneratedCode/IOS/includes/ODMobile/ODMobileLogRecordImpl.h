...
@interface ODMobileLogRecordImpl : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData,SUPLogRecord>
{
@private
    int32_t _level;
    int32_t _code;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileLogRecordImpl*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileLogRecordImpl objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileLogRecordImplList;

// internal methods declaration, only used by generated code.
@interface ODMobileLogRecordImpl(internal)
