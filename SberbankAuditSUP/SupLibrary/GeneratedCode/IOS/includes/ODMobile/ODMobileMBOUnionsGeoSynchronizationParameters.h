...
/*!
 @class ODMobileMBOUnionsGeoSynchronizationParameters
...
@interface ODMobileMBOUnionsGeoSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _LON_DELTA;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOUnionsGeoSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBOUnionsGeoSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOUnionsGeoSynchronizationParameters(internal)
