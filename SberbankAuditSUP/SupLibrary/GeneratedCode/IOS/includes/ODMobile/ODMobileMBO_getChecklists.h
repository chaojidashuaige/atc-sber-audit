...
/*!
 @class ODMobileMBO_getChecklists
...
@interface ODMobileMBO_getChecklists : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _CHECKLIST_TEMPLATE_ID;
    SUPBigString* _CHECKLIST_BODY;
    int64_t _surrogateKey;
    int64_t _CHECKLIST_BODYLength;
}

@property(retain,nonatomic) NSString* CHECKLIST_TEMPLATE_ID;
@property(retain,nonatomic) SUPBigString* CHECKLIST_BODY;
@property(assign,nonatomic) int64_t surrogateKey;
@property(assign,nonatomic) int64_t CHECKLIST_BODYLength;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getChecklists*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_getChecklists objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_getChecklistsList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getChecklists(internal)
