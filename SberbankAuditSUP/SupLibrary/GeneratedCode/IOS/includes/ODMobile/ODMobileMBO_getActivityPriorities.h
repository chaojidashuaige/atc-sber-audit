...
/*!
 @class ODMobileMBO_getActivityPriorities
...
@interface ODMobileMBO_getActivityPriorities : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _ACTIVITY_PRIORITY_ID;
    NSString* _ACTIVITY_PRIORITY_NAME;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* ACTIVITY_PRIORITY_ID;
@property(retain,nonatomic) NSString* ACTIVITY_PRIORITY_NAME;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getActivityPriorities*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_getActivityPriorities objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_getActivityPrioritiesList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getActivityPriorities(internal)
