...
@interface ODMobileMBOUnionsGeo : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _UNION_ID;
    NSString* _UNION_NAME;
    NSString* _UNION_TYPE_ID;
    NSString* _SUBBRANCH_ID;
    NSString* _ENABLED_FLG;
    NSString* _UNION_SUBBRANCHES;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* UNION_ID;
@property(retain,nonatomic) NSString* UNION_NAME;
...
@property(retain,nonatomic) NSString* UNION_SUBBRANCHES;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOUnionsGeo*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOUnionsGeo objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOUnionsGeoList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOUnionsGeo(internal)
