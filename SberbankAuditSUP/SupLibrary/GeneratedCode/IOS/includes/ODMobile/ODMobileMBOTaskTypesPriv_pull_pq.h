...
/*!
 @class ODMobileMBOTaskTypesPriv_pull_pq
...
@interface ODMobileMBOTaskTypesPriv_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
    NSString* _emloyeeIdParam;
    int64_t _id;
}

@property(retain,nonatomic) NSString* username;
@property(retain,nonatomic) NSString* remoteId;
@property(retain,nonatomic) NSString* emloyeeIdParam;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOTaskTypesPriv_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOTaskTypesPriv_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOTaskTypesPriv_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOTaskTypesPriv_pull_pq(internal)
