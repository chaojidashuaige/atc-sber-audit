...
@interface ODMobileMBOObjectTypes : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _OBJECT_TYPE_ID;
    NSString* _SUBBRANCH_LEVEL_ID;
    NSString* _OBJECT_TYPE_NAME;
    NSString* _OBJECT_TYPE_KEY;
...
@property(retain,nonatomic) NSString* OBJECT_TYPE_NAME;
@property(retain,nonatomic) NSString* OBJECT_TYPE_KEY;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOObjectTypes*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOObjectTypes objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOObjectTypesList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOObjectTypes(internal)
