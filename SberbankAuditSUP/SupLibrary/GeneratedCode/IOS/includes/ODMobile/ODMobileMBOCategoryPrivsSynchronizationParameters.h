...
/*!
 @class ODMobileMBOCategoryPrivsSynchronizationParameters
...
@interface ODMobileMBOCategoryPrivsSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _employeeId;
    BOOL _employeeIdUserDefined;
}

@property(retain,nonatomic) NSString* employeeId;
@property(assign,nonatomic) BOOL employeeIdUserDefined;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOCategoryPrivsSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBOCategoryPrivsSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOCategoryPrivsSynchronizationParameters(internal)
