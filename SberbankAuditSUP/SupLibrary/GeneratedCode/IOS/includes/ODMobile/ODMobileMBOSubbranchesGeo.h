...
/*!
 @class ODMobileMBOSubbranchesGeo
...
@interface ODMobileMBOSubbranchesGeo : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOSubbranchesGeo*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOSubbranchesGeo objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOSubbranchesGeoList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOSubbranchesGeo(internal)
