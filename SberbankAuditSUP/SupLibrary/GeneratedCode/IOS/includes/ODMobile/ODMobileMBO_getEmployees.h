...
/*!
 @class ODMobileMBO_getEmployees
...
@interface ODMobileMBO_getEmployees : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _EMPLOYEE_ID;
    NSString* _LAST_NAME;
    NSString* _FIRST_NAME;
    NSString* _PATRONYMIC;
    NSString* _EMPLOYEE_POSITION;
...
@property(retain,nonatomic) NSString* PATRONYMIC;
@property(retain,nonatomic) NSString* EMPLOYEE_POSITION;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getEmployees*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_getEmployees objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_getEmployeesList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getEmployees(internal)
