...
@interface ODMobileMBOUnions : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _UNION_ID;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOUnions*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOUnions objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOUnionsList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOUnions(internal)
