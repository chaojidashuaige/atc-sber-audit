...
/*!
 @class ODMobileMBOUnionsSynchronizationParameters
...
@interface ODMobileMBOUnionsSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOUnionsSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBOUnionsSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOUnionsSynchronizationParameters(internal)
