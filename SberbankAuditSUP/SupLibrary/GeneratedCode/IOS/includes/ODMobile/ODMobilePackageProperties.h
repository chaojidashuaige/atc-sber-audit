...
/*!
 @class ODMobilePackageProperties
...
@interface ODMobilePackageProperties : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData, SUPAbstractPackageProperties>
{
@private
    NSString* _value;
    NSString* _key;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobilePackageProperties*)load:(NSString*)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobilePackageProperties objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobilePackagePropertiesList;

// internal methods declaration, only used by generated code.
@interface ODMobilePackageProperties(internal)
