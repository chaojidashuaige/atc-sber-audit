...
@interface ODMobileMBOVisitTypes : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _VISIT_TYPE_ID;
    NSString* _VISIT_TYPE_NAME;
    NSString* _VISIT_TYPE_KEY;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* VISIT_TYPE_ID;
@property(retain,nonatomic) NSString* VISIT_TYPE_NAME;
@property(retain,nonatomic) NSString* VISIT_TYPE_KEY;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOVisitTypes*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOVisitTypes objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOVisitTypesList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOVisitTypes(internal)
