...
/*!
 @class ODMobileMBO_getTasks_pull_pq
...
@interface ODMobileMBO_getTasks_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getTasks_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_getTasks_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_getTasks_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getTasks_pull_pq(internal)
