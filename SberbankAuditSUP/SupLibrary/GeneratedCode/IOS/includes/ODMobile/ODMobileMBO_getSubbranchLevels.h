...
/*!
 @class ODMobileMBO_getSubbranchLevels
...
@interface ODMobileMBO_getSubbranchLevels : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _SUBBRANCH_LEVEL_ID;
    NSString* _SUBBRANCH_LEVEL_NAME;
    NSString* _SUBBRANCH_LEVEL_KEY;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* SUBBRANCH_LEVEL_ID;
@property(retain,nonatomic) NSString* SUBBRANCH_LEVEL_NAME;
@property(retain,nonatomic) NSString* SUBBRANCH_LEVEL_KEY;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getSubbranchLevels*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_getSubbranchLevels objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_getSubbranchLevelsList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getSubbranchLevels(internal)
