...
/*!
 @class ODMobileMBOCategoryPrivs_pull_pq
...
@interface ODMobileMBOCategoryPrivs_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
    NSString* _employeeIdParam;
    int64_t _id;
}

@property(retain,nonatomic) NSString* username;
@property(retain,nonatomic) NSString* remoteId;
@property(retain,nonatomic) NSString* employeeIdParam;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOCategoryPrivs_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOCategoryPrivs_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOCategoryPrivs_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOCategoryPrivs_pull_pq(internal)
