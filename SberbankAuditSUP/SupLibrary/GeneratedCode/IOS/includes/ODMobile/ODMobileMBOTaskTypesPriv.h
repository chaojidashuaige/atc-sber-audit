...
/*!
 @class ODMobileMBOTaskTypesPriv
...
@interface ODMobileMBOTaskTypesPriv : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOTaskTypesPriv*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOTaskTypesPriv objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOTaskTypesPrivList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOTaskTypesPriv(internal)
