...
@interface ODMobileMBO_Logon : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _logonReturn;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* logonReturn;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_Logon*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBO_Logon objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBO_LogonList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_Logon(internal)
