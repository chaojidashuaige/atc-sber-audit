...
/*!
 @class ODMobileMBOTaskTypesPrivSynchronizationParameters
...
@interface ODMobileMBOTaskTypesPrivSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _emloyeeId;
    BOOL _emloyeeIdUserDefined;
}

@property(retain,nonatomic) NSString* emloyeeId;
@property(assign,nonatomic) BOOL emloyeeIdUserDefined;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOTaskTypesPrivSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBOTaskTypesPrivSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOTaskTypesPrivSynchronizationParameters(internal)
