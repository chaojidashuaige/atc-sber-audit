...
/*!
 @class ODMobileMBOSubbranchesGeo_pull_pq
...
@interface ODMobileMBOSubbranchesGeo_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOSubbranchesGeo_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOSubbranchesGeo_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOSubbranchesGeo_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOSubbranchesGeo_pull_pq(internal)
