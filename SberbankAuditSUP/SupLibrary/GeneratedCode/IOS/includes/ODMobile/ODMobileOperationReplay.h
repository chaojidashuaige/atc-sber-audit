...
@interface ODMobileOperationReplay : SUPAbstractROEntity<SUPOperationReplay, SUPClassWithMetaData>
{
@private
    NSString* _remoteId;
    NSString* _component;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileOperationReplay*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileOperationReplay objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileOperationReplayList;

// internal methods declaration, only used by generated code.
@interface ODMobileOperationReplay(internal)
