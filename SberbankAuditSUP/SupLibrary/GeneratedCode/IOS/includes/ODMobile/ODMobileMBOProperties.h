...
@interface ODMobileMBOProperties : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
...
@property(retain,nonatomic) NSString* PROPERTIES;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOProperties*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOProperties objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOPropertiesList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOProperties(internal)
