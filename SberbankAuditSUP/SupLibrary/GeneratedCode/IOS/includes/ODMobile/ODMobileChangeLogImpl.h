...
@interface ODMobileChangeLogImpl : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData,SUPChangeLog>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileChangeLogImpl*)load:(ODMobileChangeLogKey*)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileChangeLogImpl objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileChangeLogImplList;

// internal methods declaration, only used by generated code.
@interface ODMobileChangeLogImpl(internal)
