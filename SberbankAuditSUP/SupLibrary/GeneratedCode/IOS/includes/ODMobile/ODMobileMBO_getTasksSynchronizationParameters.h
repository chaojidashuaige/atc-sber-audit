...
/*!
 @class ODMobileMBO_getTasksSynchronizationParameters
...
@interface ODMobileMBO_getTasksSynchronizationParameters : SUPAbstractSynchronizationParameters<SUPLocalBusinessObject, SUPClassWithMetaData>
{
@private
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBO_getTasksSynchronizationParameters*)load:(NSString*)id;
/*!
  @method 
...
@end
typedef SUPObjectList ODMobileMBO_getTasksSynchronizationParametersList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBO_getTasksSynchronizationParameters(internal)
