...
/*!
 @class ODMobileMBOBusinessProcess
...
@interface ODMobileMBOBusinessProcess : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _BUSINESS_PROCESS_ID;
    NSString* _BUSINESS_PROCESS_KEY;
    NSString* _BUSINESS_PROCESS_NAME;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* BUSINESS_PROCESS_ID;
@property(retain,nonatomic) NSString* BUSINESS_PROCESS_KEY;
@property(retain,nonatomic) NSString* BUSINESS_PROCESS_NAME;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOBusinessProcess*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOBusinessProcess objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOBusinessProcessList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOBusinessProcess(internal)
