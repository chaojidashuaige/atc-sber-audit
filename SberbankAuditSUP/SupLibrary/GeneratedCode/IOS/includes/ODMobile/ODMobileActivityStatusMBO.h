...
/*!
 @class ODMobileActivityStatusMBO
...
@interface ODMobileActivityStatusMBO : SUPAbstractEntityRBS<SUPMobileBusinessObject, SUPClassWithMetaData>
{
@private
    NSString* _ACTIVITY_STATUS_ID;
    NSString* _ACTIVITY_STATUS_NAME;
    NSString* _ACTIVITY_STATUS_KEY;
    int64_t _surrogateKey;
}

@property(retain,nonatomic) NSString* ACTIVITY_STATUS_ID;
@property(retain,nonatomic) NSString* ACTIVITY_STATUS_NAME;
@property(retain,nonatomic) NSString* ACTIVITY_STATUS_KEY;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileActivityStatusMBO*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileActivityStatusMBO objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileActivityStatusMBOList;

// internal methods declaration, only used by generated code.
@interface ODMobileActivityStatusMBO(internal)
