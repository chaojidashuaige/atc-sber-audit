...
/*!
 @class ODMobileMBOTaskBlockMetrics_pull_pq
...
@interface ODMobileMBOTaskBlockMetrics_pull_pq : SUPAbstractROEntity<SUPClassWithMetaData>
{
@private
    NSString* _username;
    NSString* _remoteId;
...
/*!
  ...
  @throws SUPPersistenceException
 */
+ (ODMobileMBOTaskBlockMetrics_pull_pq*)load:(int64_t)id;
/*!
  @method 
...
/*!
  @method 
  @abstract Return a list of ODMobileMBOTaskBlockMetrics_pull_pq objects
  @discussion
  @throws SUPPersistenceException
 */
...
@end
typedef SUPObjectList ODMobileMBOTaskBlockMetrics_pull_pqList;

// internal methods declaration, only used by generated code.
@interface ODMobileMBOTaskBlockMetrics_pull_pq(internal)
