...
@implementation ODMobileMBO_getActivitiesSynchronizationParameters
...
static SUPSyncParamEntityDelegate *g_ODMobileMBO_getActivitiesSynchronizationParameters_delegate = nil;

+ (SUPSyncParamEntityDelegate *) delegate
{
	@synchronized(self) {
		if (g_ODMobileMBO_getActivitiesSynchronizationParameters_delegate == nil) {
			g_ODMobileMBO_getActivitiesSynchronizationParameters_delegate = [[SUPSyncParamEntityDelegate alloc] initWithName:@"ODMobileMBO_getActivitiesSynchronizationParameters" clazz:[self class]
				metaData:[self metaData] dbDelegate:[ODMobileODMobileDB delegate] database:[ODMobileODMobileDB instance]];
		}
	}
	
	return [[g_ODMobileMBO_getActivitiesSynchronizationParameters_delegate retain] autorelease];
}

static SUPEntityMetaDataRBS* ODMobileMBO_getActivitiesSynchronizationParameters_META_DATA;

+ (SUPEntityMetaDataRBS*)metaData
{
    if (ODMobileMBO_getActivitiesSynchronizationParameters_META_DATA == nil) {
		ODMobileMBO_getActivitiesSynchronizationParameters_META_DATA = [[ODMobileMBO_getActivitiesSynchronizationParametersMetaData alloc] init];
	}
	
	return ODMobileMBO_getActivitiesSynchronizationParameters_META_DATA;
}
...
- (id) init
{
    if ((self = [super init]))
    {
        self.classMetaData = [ODMobileMBO_getActivitiesSynchronizationParameters metaData];
        [self setEntityDelegate:(SUPEntityDelegate*)[ODMobileMBO_getActivitiesSynchronizationParameters delegate]];
		self.persistentQueryDelegate = [ODMobileMBO_getActivities_pull_pq getEntityDelegateForPQ];
    }
    return self;    
}
...
+ (ODMobileMBO_getActivitiesSynchronizationParameters*)find:(NSString*)id_
{
    SUPObjectList *keys = [SUPObjectList getInstance];
    [keys add:id_];
    return (ODMobileMBO_getActivitiesSynchronizationParameters*)[(SUPEntityDelegate*)([[self class] delegate]) findEntityWithKeys:keys];
}
...
+ (ODMobileMBO_getActivitiesSynchronizationParameters*)load:(NSString*)id_
{
    return (ODMobileMBO_getActivitiesSynchronizationParameters*)[(SUPEntityDelegate*)([[self class] delegate]) load:id_];
}

+ (ODMobileMBO_getActivitiesSynchronizationParameters*)getInstance
{
    ODMobileMBO_getActivitiesSynchronizationParameters* me = [[ODMobileMBO_getActivitiesSynchronizationParameters alloc] init];
    [me autorelease];
    return me;
}
...
- (NSString*)toString
{
	...
	MBO_getActivitiesSynchronizationParameters = \n\
	    EMPLOYEE_ID = %@,\n\
