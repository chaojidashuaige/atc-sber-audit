...
@implementation ODMobileOperationReplay
...
static SUPLocalEntityDelegate *g_ODMobileOperationReplay_delegate = nil;

+ (SUPLocalEntityDelegate *) delegate
{
	@synchronized(self) {
		if (g_ODMobileOperationReplay_delegate == nil) {
			g_ODMobileOperationReplay_delegate = [[SUPLocalEntityDelegate alloc] initWithName:@"ODMobileOperationReplay" clazz:[self class]
				metaData:[self metaData] dbDelegate:[ODMobileODMobileDB delegate] database:[ODMobileODMobileDB instance]];
		}
	}
	
	return [[g_ODMobileOperationReplay_delegate retain] autorelease];
}

static SUPEntityMetaDataRBS* ODMobileOperationReplay_META_DATA;

+ (SUPEntityMetaDataRBS*)metaData
{
    if (ODMobileOperationReplay_META_DATA == nil) {
		ODMobileOperationReplay_META_DATA = [[ODMobileOperationReplayMetaData alloc] init];
	}
	
	return ODMobileOperationReplay_META_DATA;
}
...
- (id) init
{
    if ((self = [super init]))
    {
        self.classMetaData = [ODMobileOperationReplay metaData];
        [self setEntityDelegate:(SUPEntityDelegate*)[ODMobileOperationReplay delegate]];
    }
    return self;    
}
...
+ (ODMobileOperationReplay*)find:(int64_t)id_
{
    SUPObjectList *keys = [SUPObjectList getInstance];
    [keys add:[NSNumber numberWithLong:id_]];
    return (ODMobileOperationReplay*)[(SUPEntityDelegate*)([[self class] delegate]) findEntityWithKeys:keys];
}
...
+ (ODMobileOperationReplay*)load:(int64_t)id_
{
    return (ODMobileOperationReplay*)[(SUPEntityDelegate*)([[self class] delegate]) load:[NSNumber numberWithLong:id_]];
}

+ (ODMobileOperationReplay*)getInstance
{
    ODMobileOperationReplay* me = [[ODMobileOperationReplay alloc] init];
    [me autorelease];
    return me;
}
...
{
   return [ODMobileLogRecordImpl findByEntity:@"OperationReplay":[self keyToString]];
}
...
+ (SUPObjectList*)findReadyToReplay:(NSString*)remoteId skip:(int32_t)skip take:(int32_t)take
{
	...
	return (SUPObjectList*)[[[self class] delegate] findWithSQL:sql withDataTypes:dts withValues:values withIDs:ids withSkip:skip withTake:take withClass:[ODMobileOperationReplay class]];
}
