...
@implementation ODMobileMBO_getSubbranches
...
static SUPEntityDelegate *g_ODMobileMBO_getSubbranches_delegate = nil;

+ (SUPEntityDelegate *) delegate
{
	@synchronized(self) {
		if (g_ODMobileMBO_getSubbranches_delegate == nil) {
			g_ODMobileMBO_getSubbranches_delegate = [[SUPEntityDelegate alloc] initWithName:@"ODMobileMBO_getSubbranches" clazz:[self class]
				metaData:[self metaData] dbDelegate:[ODMobileODMobileDB delegate] database:[ODMobileODMobileDB instance]];
		}
	}
	
	return [[g_ODMobileMBO_getSubbranches_delegate retain] autorelease];
}

static SUPEntityMetaDataRBS* ODMobileMBO_getSubbranches_META_DATA;

+ (SUPEntityMetaDataRBS*)metaData
{
    if (ODMobileMBO_getSubbranches_META_DATA == nil) {
		ODMobileMBO_getSubbranches_META_DATA = [[ODMobileMBO_getSubbranchesMetaData alloc] init];
	}
	
	return ODMobileMBO_getSubbranches_META_DATA;
}
...
- (id) init
{
    if ((self = [super init]))
    {
        self.classMetaData = [ODMobileMBO_getSubbranches metaData];
        [self setEntityDelegate:(SUPEntityDelegate*)[ODMobileMBO_getSubbranches delegate]];
    }
    return self;    
}
...
+ (ODMobileMBO_getSubbranches*)find:(int64_t)id_
{
    ...
    return (ODMobileMBO_getSubbranches*)[(SUPEntityDelegate*)([[self class] delegate]) findEntityWithKeys:keys];
}

+ (SUPObjectList*)findWithQuery:(SUPQuery*)query
{
    return (SUPObjectList*)[(SUPEntityDelegate*)([[self class] delegate])  findWithQuery:query:[ODMobileMBO_getSubbranches class]];
}
...
+ (ODMobileMBO_getSubbranches*)load:(int64_t)id_
{
    return (ODMobileMBO_getSubbranches*)[(SUPEntityDelegate*)([[self class] delegate]) load:[NSNumber numberWithLong:id_]];
}

+ (ODMobileMBO_getSubbranches*)getInstance
{
    ODMobileMBO_getSubbranches* me = [[ODMobileMBO_getSubbranches alloc] init];
    [me autorelease];
    return me;
}
...
- (ODMobileMBO_getSubbranches*)getDownloadState
{
    return (ODMobileMBO_getSubbranches*)[self i_getDownloadState];
}

- (ODMobileMBO_getSubbranches*) getOriginalState
{
    return (ODMobileMBO_getSubbranches*)[self i_getOriginalState];
}
...
{
   return [ODMobileLogRecordImpl findByEntity:@"MBO_getSubbranches":[self keyToString]];
}
...
+ (SUPObjectList*)findAll:(int32_t)skip take:(int32_t)take
{
	...
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:372] autorelease];
	[_selectSQL appendString:@" x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"j\",x.\"l\",x.\"m\",x.\"n\",x.\"o\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"p\",x.\"_rc\",x.\"_ds\" FROM \"odmobile_1_21_mbo_getsubbranches\" x where (((x.\"_pf\" = 1 or not exists (select x_os.\"p\" from \"odmobile_1_21_mbo_getsubbranche"
	                               "s_os\" x_os where x_os.\"p\" = x.\"p\"))))"];
	...
	return (SUPObjectList*)[[[self class] delegate] findWithSQL:sql withDataTypes:dts withValues:values withIDs:ids withSkip:skip withTake:take withClass:[ODMobileMBO_getSubbranches class]];
}
...
+ (ODMobileMBO_getSubbranches*)findByPrimaryKey:(NSString*)sUBBRANCH_ID
{
	NSMutableString *sql = nil;
	NSMutableString *_selectSQL = nil;
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:397] autorelease];
	[_selectSQL appendString:@"SELECT x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"j\",x.\"l\",x.\"m\",x.\"n\",x.\"o\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"p\",x.\"_rc\",x.\"_ds\" FROM \"odmobile_1_21_mbo_getsubbranches\" x WHERE (((x.\"_pf\" = 1 or not exists (select x_os.\"p\" from \"odmobile_1_21_mbo_getsubb"
	                               "ranches_os\" x_os where x_os.\"p\" = x.\"p\")))) and ( x.\"a\" = ?)"];
	...
	SUPObjectList* res = (SUPObjectList*)[[[self class] delegate] findWithSQL:sql withDataTypes:dts withValues:values withIDs:ids withClass:[ODMobileMBO_getSubbranches class]];
	if(res && ([res size] > 0))
	{   
		ODMobileMBO_getSubbranches* cus = (ODMobileMBO_getSubbranches*)[res item:0];
	    return cus;
	}
	else
	    return nil;
...
{
	return [self getByParentId:parentId skip:0 take:INT_MAX]; 
}
...
+ (SUPObjectList*)getByParentId:(NSString*)parentId skip:(int32_t)skip take:(int32_t)take
{
	NSMutableString *sql = nil;
	NSMutableString *_selectSQL = nil;
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:391] autorelease];
	[_selectSQL appendString:@" x.\"a\",x.\"b\",x.\"c\",x.\"d\",x.\"e\",x.\"f\",x.\"g\",x.\"h\",x.\"i\",x.\"j\",x.\"l\",x.\"m\",x.\"n\",x.\"o\",x.\"_pf\",x.\"_pc\",x.\"_rp\",x.\"_rf\",x.\"p\",x.\"_rc\",x.\"_ds\" FROM \"odmobile_1_21_mbo_getsubbranches\" x WHERE (((x.\"_pf\" = 1 or not exists (select x_os.\"p\" from \"odmobile_1_21_mbo_getsubbranche"
	                               "s_os\" x_os where x_os.\"p\" = x.\"p\")))) and ( x.\"j\" = ?)"];
	sql = [[NSMutableString alloc] initWithFormat:@"select %@", _selectSQL];
	[sql autorelease];
	SUPStringList *ids = [SUPStringList listWithCapacity:0];
	SUPObjectList *dts = [SUPObjectList getInstance];
...
{
	return [self getRowsCount:0 take:INT_MAX]; 
}
...
+ (SUPQueryResultSet*)getRowsCount:(int32_t)skip take:(int32_t)take
{
	NSMutableString *sql = nil;
	NSMutableString *_selectSQL = nil;
	_selectSQL = [[[NSMutableString alloc] initWithCapacity:53] autorelease];
	[_selectSQL appendString:@" COUNT(*) FROM \"odmobile_1_21_mbo_getsubbranches\""];
	sql = [[NSMutableString alloc] initWithFormat:@"select %@", _selectSQL];
	[sql autorelease];
	SUPObjectList *dts = [SUPObjectList getInstance];
	SUPObjectList* values = [SUPObjectList getInstance];
...
{
    return (ODMobileMBO_getSubbranchesSynchronizationParameters*)[(SUPSyncParamEntityDelegate*)([[ODMobileODMobileDB delegate] getDelegate:@"MBO_getSubbranchesSynchronizationParameters"]) getSynchronizationParameters];
}
