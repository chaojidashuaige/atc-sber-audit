...
@implementation ODMobileMBOTaskBlockMetricsMetaData

+ (ODMobileMBOTaskBlockMetricsMetaData*)getInstance
{
    return [[[ODMobileMBOTaskBlockMetricsMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 15;
		self.name = @"MBOTaskBlockMetrics";
		self.klass = [ODMobileMBOTaskBlockMetrics class];
		...
		[attributes addThis:a_QUESTION_BLOCK_ID];
		[attributes addThis:a_METRIC_ID];
		[attributes addThis:a_METRIC_VALUE];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOTaskBlockMetrics*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByTaskId_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"getByTaskId":[SUPDataType forName:@"com.sybase.persistence.QueryResultSet"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getByTaskId_TASK_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"TASK_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getByTaskId_TASK_ID];
			o_getByTaskId_1.parameters = parameters_list;
	 	}
		[o_getByTaskId_1 setIsStatic:YES];
		[o_getByTaskId_1 setIsCreate:NO];
		[o_getByTaskId_1 setIsUpdate:NO];
		[o_getByTaskId_1 setIsDelete:NO]; 		
		...
		[o_cancelPendingOperations_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSynchronizationParameters_0 = [SUPOperationMetaData createOperationMetaData:9:(SUPString)@"getSynchronizationParameters":[SUPDataType forName:@"MBOTaskBlockMetricsSynchronizationParameters"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBOTaskBlockMetrics*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_getByTaskId_1];
		...
		i_getByTaskIdIndex.name = @"getByTaskIdIndex";
		[i_getByTaskIdIndex.attributes add:a_TASK_ID];
	
		[self.indexList add:i_getByTaskIdIndex];
