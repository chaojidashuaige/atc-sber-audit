#import "ODMobileMBO_getActivitiesSynchronizationParametersMetaData.h"
...
@implementation ODMobileMBO_getActivitiesSynchronizationParametersMetaData

+ (ODMobileMBO_getActivitiesSynchronizationParametersMetaData*)getInstance
{
    return [[[ODMobileMBO_getActivitiesSynchronizationParametersMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 50;
		self.name = @"MBO_getActivitiesSynchronizationParameters";
		self.klass = [ODMobileMBO_getActivitiesSynchronizationParameters class];
		...
		self.table = @"co_odmobile_1_20_mbo_getactivitiessp";
