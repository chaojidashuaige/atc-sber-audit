#import "ODMobileMBO_getActivityPrioritiesMetaData.h"
...
@implementation ODMobileMBO_getActivityPrioritiesMetaData

+ (ODMobileMBO_getActivityPrioritiesMetaData*)getInstance
{
    return [[[ODMobileMBO_getActivityPrioritiesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 28;
		self.name = @"MBO_getActivityPriorities";
		self.klass = [ODMobileMBO_getActivityPriorities class];
		...
		SUPAttributeMetaDataRBS* a_ACTIVITY_PRIORITY_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			775:
			[SUPDataType forName:@"string"]:@"varchar(80)":@"ACTIVITY_PRIORITY_ID":@"":@"a":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_ACTIVITY_PRIORITY_ID setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_ACTIVITY_PRIORITY_NAME = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			776:
			[SUPDataType forName:@"string?"]:@"varchar(1200)":@"ACTIVITY_PRIORITY_NAME":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_ACTIVITY_PRIORITY_NAME setColumn:@"b"];
		...
		[attributes addThis:a_ACTIVITY_PRIORITY_NAME];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getActivityPriorities*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getActivityPriorities"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_ACTIVITY_PRIORITY_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"ACTIVITY_PRIORITY_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_ACTIVITY_PRIORITY_ID];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getActivityPriorities*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		self.table = @"odmobile_1_21_mbo_getactivitypriorities";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_ACTIVITY_PRIORITY_ID];
