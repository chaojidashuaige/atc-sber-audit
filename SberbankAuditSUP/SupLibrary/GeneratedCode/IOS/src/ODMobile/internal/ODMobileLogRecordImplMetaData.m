...
@implementation ODMobileLogRecordImplMetaData

+ (ODMobileLogRecordImplMetaData*)getInstance
{
    return [[[ODMobileLogRecordImplMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [ODMobileLogRecordImpl class];
		...
		self.table = @"odmobile_1_21_logrecordimpl";
