...
@implementation ODMobileMBOUnionTypesMetaData

+ (ODMobileMBOUnionTypesMetaData*)getInstance
{
    return [[[ODMobileMBOUnionTypesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 19;
		self.name = @"MBOUnionTypes";
		self.klass = [ODMobileMBOUnionTypes class];
		...
		SUPAttributeMetaDataRBS* a_UNION_TYPE_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			722:
			[SUPDataType forName:@"string"]:@"varchar(80)":@"UNION_TYPE_ID":@"":@"a":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_UNION_TYPE_ID setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_UNION_TYPE_NAME = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			723:
			[SUPDataType forName:@"string?"]:@"varchar(1200)":@"UNION_TYPE_NAME":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_UNION_TYPE_NAME setColumn:@"b"];
		SUPAttributeMetaDataRBS* a_UNION_TYPE_KEY = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			724:
			[SUPDataType forName:@"string?"]:@"varchar(400)":@"UNION_TYPE_KEY":@"":@"c":
			@"":400:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_UNION_TYPE_KEY setColumn:@"c"];
		...
		[attributes addThis:a_UNION_TYPE_NAME];
		[attributes addThis:a_UNION_TYPE_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOUnionTypes*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBOUnionTypes"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_UNION_TYPE_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"UNION_TYPE_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_UNION_TYPE_ID];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBOUnionTypes*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		self.table = @"odmobile_1_21_mbouniontypes";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_UNION_TYPE_ID];
