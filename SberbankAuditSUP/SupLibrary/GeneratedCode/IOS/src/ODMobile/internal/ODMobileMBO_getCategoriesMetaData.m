...
@implementation ODMobileMBO_getCategoriesMetaData

+ (ODMobileMBO_getCategoriesMetaData*)getInstance
{
    return [[[ODMobileMBO_getCategoriesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 30;
		self.name = @"MBO_getCategories";
		self.klass = [ODMobileMBO_getCategories class];
		...
		[attributes addThis:a_CATEGORY_NAME];
		[attributes addThis:a_CATEGORY_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getCategories*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getCategories"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_CATEGORY_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"CATEGORY_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_CATEGORY_ID];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getCategories*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[i_findByPrimaryKeyIndex.attributes add:a_CATEGORY_ID];
