...
@implementation ODMobileMBO_getChecklistsMetaData

+ (ODMobileMBO_getChecklistsMetaData*)getInstance
{
    return [[[ODMobileMBO_getChecklistsMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 31;
		self.name = @"MBO_getChecklists";
		self.klass = [ODMobileMBO_getChecklists class];
		...
		SUPAttributeMetaDataRBS* a_CHECKLIST_BODYLength = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			...
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_CHECKLIST_BODYLength setColumn:@"CHECKLIST_BODY_length"];
 		
		[attributes addThis:a_CHECKLIST_TEMPLATE_ID];
		[attributes addThis:a_CHECKLIST_BODY];
		...
		[attributes addThis:a_CHECKLIST_BODYLength];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getChecklists*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getChecklists"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_CHECKLIST_TEMPLATE_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"CHECKLIST_TEMPLATE_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_CHECKLIST_TEMPLATE_ID];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getChecklists*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[i_findByPrimaryKeyIndex.attributes add:a_CHECKLIST_TEMPLATE_ID];
