...
@implementation ODMobileMBOTaskTypesPriv_pull_pqMetaData

+ (ODMobileMBOTaskTypesPriv_pull_pqMetaData*)getInstance
{
    return [[[ODMobileMBOTaskTypesPriv_pull_pqMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 18;
		self.name = @"MBOTaskTypesPriv_pull_pq";
		self.klass = [ODMobileMBOTaskTypesPriv_pull_pq class];
		...
		[attributes addThis:a_emloyeeIdParam];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOTaskTypesPriv_pull_pq*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findSub_2 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findSub":[SUPDataType forName:@"MBOTaskTypesPriv_pull_pq?"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		...
	 		SUPParameterMetaData* p_findSub_emloyeeId = [SUPParameterMetaData createParameterMetaData:2:(SUPString)@"emloyeeId":[SUPDataType forName:@"string?"]];
 			parameters_list = [SUPObjectList listWithCapacity:2];
			[parameters_list addThis:p_findSub__username];
			[parameters_list addThis:p_findSub_emloyeeId];
		...
		[i_param_pull_index.attributes add:a_emloyeeIdParam];
