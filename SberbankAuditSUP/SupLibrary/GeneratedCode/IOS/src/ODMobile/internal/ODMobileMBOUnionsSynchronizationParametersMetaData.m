...
@implementation ODMobileMBOUnionsSynchronizationParametersMetaData

+ (ODMobileMBOUnionsSynchronizationParametersMetaData*)getInstance
{
    return [[[ODMobileMBOUnionsSynchronizationParametersMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 48;
		self.name = @"MBOUnionsSynchronizationParameters";
		self.klass = [ODMobileMBOUnionsSynchronizationParameters class];
