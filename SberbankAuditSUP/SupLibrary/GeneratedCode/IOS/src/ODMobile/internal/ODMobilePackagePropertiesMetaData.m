...
@implementation ODMobilePackagePropertiesMetaData

+ (ODMobilePackagePropertiesMetaData*)getInstance
{
    return [[[ODMobilePackagePropertiesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [ODMobilePackageProperties class];
		...
		self.table = @"odmobile_1_20_packageproperties";
