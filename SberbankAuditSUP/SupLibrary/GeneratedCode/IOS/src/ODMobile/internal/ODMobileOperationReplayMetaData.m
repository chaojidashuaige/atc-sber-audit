#import "ODMobileOperationReplayMetaData.h"
...
@implementation ODMobileOperationReplayMetaData

+ (ODMobileOperationReplayMetaData*)getInstance
{
    return [[[ODMobileOperationReplayMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [ODMobileOperationReplay class];
		...
		self.table = @"odmobile_1_20_operationreplay";
