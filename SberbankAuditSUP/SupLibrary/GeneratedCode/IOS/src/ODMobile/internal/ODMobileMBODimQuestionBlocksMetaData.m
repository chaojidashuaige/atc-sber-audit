...
@implementation ODMobileMBODimQuestionBlocksMetaData

+ (ODMobileMBODimQuestionBlocksMetaData*)getInstance
{
    return [[[ODMobileMBODimQuestionBlocksMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 9;
		self.name = @"MBODimQuestionBlocks";
		self.klass = [ODMobileMBODimQuestionBlocks class];
		...
		SUPAttributeMetaDataRBS* a_QUESTION_BLOCK_NAME = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			...
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_QUESTION_BLOCK_NAME setColumn:@"b"];
		...
		[attributes addThis:a_QUESTION_BLOCK_NAME];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBODimQuestionBlocks*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBODimQuestionBlocks"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_QUESTION_BLOCK_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"QUESTION_BLOCK_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_QUESTION_BLOCK_ID];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:10:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBODimQuestionBlocks*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[i_findByPrimaryKeyIndex.attributes add:a_QUESTION_BLOCK_ID];
