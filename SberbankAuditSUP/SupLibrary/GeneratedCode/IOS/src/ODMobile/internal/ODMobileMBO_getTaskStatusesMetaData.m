...
@implementation ODMobileMBO_getTaskStatusesMetaData

+ (ODMobileMBO_getTaskStatusesMetaData*)getInstance
{
    return [[[ODMobileMBO_getTaskStatusesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 36;
		self.name = @"MBO_getTaskStatuses";
		self.klass = [ODMobileMBO_getTaskStatuses class];
		...
		SUPAttributeMetaDataRBS* a_TASK_STATUS_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			817:
			[SUPDataType forName:@"string"]:@"varchar(80)":@"TASK_STATUS_ID":@"":@"a":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_TASK_STATUS_ID setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_TASK_STATUS_NAME = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			818:
			[SUPDataType forName:@"string?"]:@"varchar(1200)":@"TASK_STATUS_NAME":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_TASK_STATUS_NAME setColumn:@"b"];
		SUPAttributeMetaDataRBS* a_TASK_STATUS_KEY = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			819:
			[SUPDataType forName:@"string?"]:@"varchar(400)":@"TASK_STATUS_KEY":@"":@"c":
			@"":400:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_TASK_STATUS_KEY setColumn:@"c"];
		...
		[attributes addThis:a_TASK_STATUS_NAME];
		[attributes addThis:a_TASK_STATUS_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getTaskStatuses*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getTaskStatuses"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_TASK_STATUS_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"TASK_STATUS_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_TASK_STATUS_ID];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByKey_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByKey":[SUPDataType forName:@"MBO_getTaskStatuses"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getByKey_statusKey = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"statusKey":[SUPDataType forName:@"string?"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getByKey_statusKey];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getTaskStatuses*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		self.table = @"odmobile_1_21_mbo_gettaskstatuses";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_TASK_STATUS_ID];
