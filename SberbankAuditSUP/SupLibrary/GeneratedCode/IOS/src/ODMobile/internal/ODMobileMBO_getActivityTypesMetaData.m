...
@implementation ODMobileMBO_getActivityTypesMetaData

+ (ODMobileMBO_getActivityTypesMetaData*)getInstance
{
    return [[[ODMobileMBO_getActivityTypesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 29;
		self.name = @"MBO_getActivityTypes";
		self.klass = [ODMobileMBO_getActivityTypes class];
		...
		SUPAttributeMetaDataRBS* a_ACTIVITY_TYPE_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			127:
			[SUPDataType forName:@"string"]:@"varchar(80)":@"ACTIVITY_TYPE_ID":@"":@"a":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:NO:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_ACTIVITY_TYPE_ID setColumn:@"a"];
		SUPAttributeMetaDataRBS* a_ACTIVITY_TYPE_NAME = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			128:
			[SUPDataType forName:@"string?"]:@"varchar(1200)":@"ACTIVITY_TYPE_NAME":@"":@"b":
			@"":1200:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_ACTIVITY_TYPE_NAME setColumn:@"b"];
		SUPAttributeMetaDataRBS* a_CATEGORY_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			129:
			[SUPDataType forName:@"string?"]:@"varchar(80)":@"CATEGORY_ID":@"":@"c":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_CATEGORY_ID setColumn:@"c"];
		SUPAttributeMetaDataRBS* a_BUSINESS_PROCESS_ID = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			130:
			[SUPDataType forName:@"string?"]:@"varchar(80)":@"BUSINESS_PROCESS_ID":@"":@"d":
			@"":80:0:0:
			@"null":NO:@"":
			NO:NO:YES:NO:NO:NO:
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_BUSINESS_PROCESS_ID setColumn:@"d"];
		...
		[attributes addThis:a_ACTIVITY_TYPE_NAME];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getActivityTypes*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getActivityTypes"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_ACTIVITY_TYPE_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"ACTIVITY_TYPE_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_ACTIVITY_TYPE_ID];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByCategoryId_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByCategoryId":[SUPDataType forName:@"MBO_getActivityTypes*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getByCategoryId_categoryId = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"categoryId":[SUPDataType forName:@"string?"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getByCategoryId_categoryId];
			o_getByCategoryId_1.parameters = parameters_list;
	 	}
		[o_getByCategoryId_1 setIsStatic:YES];
		[o_getByCategoryId_1 setIsCreate:NO];
		[o_getByCategoryId_1 setIsUpdate:NO];
		[o_getByCategoryId_1 setIsDelete:NO]; 		
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getActivityTypes*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_getByCategoryId_1];
		...
		self.table = @"odmobile_1_20_mbo_getactivitytypes";
		...
		[i_findByPrimaryKeyIndex.attributes add:a_ACTIVITY_TYPE_ID];
	
		SUPIndexMetaData *i_getByCategoryIdIndex = [[[SUPIndexMetaData alloc] init] autorelease];
		i_getByCategoryIdIndex.name = @"getByCategoryIdIndex";
		[i_getByCategoryIdIndex.attributes add:a_CATEGORY_ID];
	
		[self.indexList add:i_findByPrimaryKeyIndex];
		[self.indexList add:i_getByCategoryIdIndex];
