...
@implementation ODMobileMBOVisitTypesMetaData

+ (ODMobileMBOVisitTypesMetaData*)getInstance
{
    return [[[ODMobileMBOVisitTypesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 24;
		self.name = @"MBOVisitTypes";
		self.klass = [ODMobileMBOVisitTypes class];
		...
		[attributes addThis:a_VISIT_TYPE_NAME];
		[attributes addThis:a_VISIT_TYPE_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOVisitTypes*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBOVisitTypes"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_VISIT_TYPE_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"VISIT_TYPE_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_VISIT_TYPE_ID];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByKey_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByKey":[SUPDataType forName:@"MBOVisitTypes"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBOVisitTypes*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[i_findByPrimaryKeyIndex.attributes add:a_VISIT_TYPE_ID];
