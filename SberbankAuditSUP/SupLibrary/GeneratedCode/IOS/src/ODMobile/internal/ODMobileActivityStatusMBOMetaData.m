...
@implementation ODMobileActivityStatusMBOMetaData

+ (ODMobileActivityStatusMBOMetaData*)getInstance
{
    return [[[ODMobileActivityStatusMBOMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 0;
		self.name = @"ActivityStatusMBO";
		self.klass = [ODMobileActivityStatusMBO class];
		...
		SUPAttributeMetaDataRBS* a_ACTIVITY_STATUS_KEY = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			...
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_ACTIVITY_STATUS_KEY setColumn:@"c"];
		...
		[attributes addThis:a_ACTIVITY_STATUS_NAME];
		[attributes addThis:a_ACTIVITY_STATUS_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"ActivityStatusMBO*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"ActivityStatusMBO"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_ACTIVITY_STATUS_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"ACTIVITY_STATUS_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_ACTIVITY_STATUS_ID];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByStatusKey_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByStatusKey":[SUPDataType forName:@"ActivityStatusMBO"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getByStatusKey_STATUS_KEY = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"STATUS_KEY":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getByStatusKey_STATUS_KEY];
			o_getByStatusKey_1.parameters = parameters_list;
	 	}
		[o_getByStatusKey_1 setIsStatic:YES];
		[o_getByStatusKey_1 setIsCreate:NO];
		[o_getByStatusKey_1 setIsUpdate:NO];
		[o_getByStatusKey_1 setIsDelete:NO]; 		
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"ActivityStatusMBO*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_getByStatusKey_1];
		...
		[i_findByPrimaryKeyIndex.attributes add:a_ACTIVITY_STATUS_ID];
