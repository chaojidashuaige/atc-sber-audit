#import "ODMobileMBOUnionsMetaData.h"
...
@implementation ODMobileMBOUnionsMetaData

+ (ODMobileMBOUnionsMetaData*)getInstance
{
    return [[[ODMobileMBOUnionsMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 20;
		self.name = @"MBOUnions";
		self.klass = [ODMobileMBOUnions class];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOUnions*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBOUnions"]:true];
	  	{
		...
		[o_cancelPendingOperations_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSynchronizationParameters_0 = [SUPOperationMetaData createOperationMetaData:9:(SUPString)@"getSynchronizationParameters":[SUPDataType forName:@"MBOUnionsSynchronizationParameters"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBOUnions*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		self.table = @"odmobile_1_21_mbounions";
