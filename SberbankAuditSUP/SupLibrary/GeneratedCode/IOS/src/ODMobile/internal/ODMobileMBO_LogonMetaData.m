...
@implementation ODMobileMBO_LogonMetaData

+ (ODMobileMBO_LogonMetaData*)getInstance
{
    return [[[ODMobileMBO_LogonMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 25;
		self.name = @"MBO_Logon";
		self.klass = [ODMobileMBO_Logon class];
		...
		[attributes addThis:a_logonReturn];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_Logon*"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:9:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_Logon*"]:true];
	  	{
