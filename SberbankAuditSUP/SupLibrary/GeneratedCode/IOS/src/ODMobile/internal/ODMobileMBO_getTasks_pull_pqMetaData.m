#import "ODMobileMBO_getTasks_pull_pqMetaData.h"
...
@implementation ODMobileMBO_getTasks_pull_pqMetaData

+ (ODMobileMBO_getTasks_pull_pqMetaData*)getInstance
{
    return [[[ODMobileMBO_getTasks_pull_pqMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 39;
		self.name = @"MBO_getTasks_pull_pq";
		self.klass = [ODMobileMBO_getTasks_pull_pq class];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getTasks_pull_pq*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findSub_3 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findSub":[SUPDataType forName:@"MBO_getTasks_pull_pq?"]:true];
	  	{
		...
		self.table = @"odmobile_1_20_mbo_gettasks_pull_pq";
