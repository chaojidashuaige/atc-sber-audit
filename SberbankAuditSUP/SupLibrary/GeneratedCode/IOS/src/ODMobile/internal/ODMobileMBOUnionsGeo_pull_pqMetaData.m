...
@implementation ODMobileMBOUnionsGeo_pull_pqMetaData

+ (ODMobileMBOUnionsGeo_pull_pqMetaData*)getInstance
{
    return [[[ODMobileMBOUnionsGeo_pull_pqMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 22;
		self.name = @"MBOUnionsGeo_pull_pq";
		self.klass = [ODMobileMBOUnionsGeo_pull_pq class];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBOUnionsGeo_pull_pq*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findSub_5 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findSub":[SUPDataType forName:@"MBOUnionsGeo_pull_pq?"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		...
	 		SUPParameterMetaData* p_findSub_LON_DELTA = [SUPParameterMetaData createParameterMetaData:2:(SUPString)@"LON_DELTA":[SUPDataType forName:@"string?"]];
	 		SUPParameterMetaData* p_findSub_LAT_DELTA = [SUPParameterMetaData createParameterMetaData:3:(SUPString)@"LAT_DELTA":[SUPDataType forName:@"string?"]];
	 		SUPParameterMetaData* p_findSub_LAT = [SUPParameterMetaData createParameterMetaData:4:(SUPString)@"LAT":[SUPDataType forName:@"string?"]];
