...
@implementation ODMobileLocalKeyGeneratorMetaData

+ (ODMobileLocalKeyGeneratorMetaData*)getInstance
{
    return [[[ODMobileLocalKeyGeneratorMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [ODMobileLocalKeyGenerator class];
		...
		self.table = @"co_odmobile_1_21_localkeygenerator";
