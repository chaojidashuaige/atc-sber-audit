#import "ODMobileMBO_getSubbranchesMetaData.h"
...
@implementation ODMobileMBO_getSubbranchesMetaData

+ (ODMobileMBO_getSubbranchesMetaData*)getInstance
{
    return [[[ODMobileMBO_getSubbranchesMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 34;
		self.name = @"MBO_getSubbranches";
		self.klass = [ODMobileMBO_getSubbranches class];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getSubbranches*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getSubbranches"]:true];
	  	{
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByParentId_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByParentId":[SUPDataType forName:@"MBO_getSubbranches*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_getByParentId_parentId = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"parentId":[SUPDataType forName:@"string?"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_getByParentId_parentId];
			o_getByParentId_1.parameters = parameters_list;
	 	}
		[o_getByParentId_1 setIsStatic:YES];
		[o_getByParentId_1 setIsCreate:NO];
		[o_getByParentId_1 setIsUpdate:NO];
		[o_getByParentId_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getRowsCount_0 = [SUPOperationMetaData createOperationMetaData:4:(SUPString)@"getRowsCount":[SUPDataType forName:@"com.sybase.persistence.QueryResultSet"]:true];
		[o_getRowsCount_0 setIsStatic:YES];
		[o_getRowsCount_0 setIsCreate:NO];
		[o_getRowsCount_0 setIsUpdate:NO];
		[o_getRowsCount_0 setIsDelete:NO]; 		
		...
		[o_cancelPendingOperations_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getSynchronizationParameters_0 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"getSynchronizationParameters":[SUPDataType forName:@"MBO_getSubbranchesSynchronizationParameters"]:true];
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:13:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getSubbranches*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_getSize_1 setIsDelete:NO]; 		
 		...
 		[operations addThis:o_getByParentId_1];
 		[operations addThis:o_getRowsCount_0];
		...
		SUPIndexMetaData *i_getByParentIdIndex = [[[SUPIndexMetaData alloc] init] autorelease];
		i_getByParentIdIndex.name = @"getByParentIdIndex";
		[i_getByParentIdIndex.attributes add:a_PARENT_ID];
	
		[self.indexList add:i_findByPrimaryKeyIndex];
		[self.indexList add:i_getByParentIdIndex];
