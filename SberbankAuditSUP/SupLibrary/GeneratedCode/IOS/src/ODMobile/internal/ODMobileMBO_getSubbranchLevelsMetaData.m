...
@implementation ODMobileMBO_getSubbranchLevelsMetaData

+ (ODMobileMBO_getSubbranchLevelsMetaData*)getInstance
{
    return [[[ODMobileMBO_getSubbranchLevelsMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		self.id = 33;
		self.name = @"MBO_getSubbranchLevels";
		self.klass = [ODMobileMBO_getSubbranchLevels class];
		...
		SUPAttributeMetaDataRBS* a_SUBBRANCH_LEVEL_KEY = [SUPAttributeMetaDataRBS attributeMetaDataWith:
			...
			GeneratedScheme_NONE:
			NO:SUPPersonalizationType_None:NO];
		[a_SUBBRANCH_LEVEL_KEY setColumn:@"c"];
		...
		[attributes addThis:a_SUBBRANCH_LEVEL_NAME];
		[attributes addThis:a_SUBBRANCH_LEVEL_KEY];
		...
		SUPAttributeMap * attributeMap = [SUPAttributeMap getInstance];
 		...
 		SUPOperationMetaData* o_findAll_0 = [SUPOperationMetaData createOperationMetaData:1:(SUPString)@"findAll":[SUPDataType forName:@"MBO_getSubbranchLevels*"]:true];
		[o_findAll_0 setIsStatic:YES];
		[o_findAll_0 setIsCreate:NO];
		[o_findAll_0 setIsUpdate:NO];
		[o_findAll_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findByPrimaryKey_1 = [SUPOperationMetaData createOperationMetaData:2:(SUPString)@"findByPrimaryKey":[SUPDataType forName:@"MBO_getSubbranchLevels"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
	 		SUPParameterMetaData* p_findByPrimaryKey_SUBBRANCH_LEVEL_ID = [SUPParameterMetaData createParameterMetaData:1:(SUPString)@"SUBBRANCH_LEVEL_ID":[SUPDataType forName:@"string"]];
 			parameters_list = [SUPObjectList listWithCapacity:1];
			[parameters_list addThis:p_findByPrimaryKey_SUBBRANCH_LEVEL_ID];
		...
		[o_findByPrimaryKey_1 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_getByKey_1 = [SUPOperationMetaData createOperationMetaData:3:(SUPString)@"getByKey":[SUPDataType forName:@"MBO_getSubbranchLevels"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[o_save_0 setIsDelete:NO]; 		
 		SUPOperationMetaData* o_findWithQuery_1 = [SUPOperationMetaData createOperationMetaData:11:(SUPString)@"findWithQuery":[SUPDataType forName:@"MBO_getSubbranchLevels*"]:true];
	  	{
			SUPObjectList *parameters_list = nil;
		...
		[i_findByPrimaryKeyIndex.attributes add:a_SUBBRANCH_LEVEL_ID];
