...
@implementation ODMobileSISSubscriptionMetaData

+ (ODMobileSISSubscriptionMetaData*)getInstance
{
    return [[[ODMobileSISSubscriptionMetaData alloc] init] autorelease];
}
...
- (id)init
{
    if (self = [super init]) {
		...
		self.klass = [ODMobileSISSubscription class];
