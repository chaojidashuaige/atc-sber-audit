...
@protocol SUPConnectionWrapperUL <NSObject,SUPConnectionWrapper>

- (NSDate*)getLastDownloadTime:(NSString*)synchronizationGroup;
- (void)resetLastDownloadTime:(NSString*)synchronizationGroup;
