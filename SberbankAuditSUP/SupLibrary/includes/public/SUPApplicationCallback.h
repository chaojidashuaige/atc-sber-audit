 ...
 */
@protocol SUPApplicationCallback<NSObject>
...
/*!
 @method
 @abstract Invoked when a response is needed to a certificate challenge during HTTPS handshake negotiation.
 @discussion The default implementation of this method in @link //apple_ref/occ/cl/SUPApplicationDefaultCallback SUPApplicationDefaultCallback @/link will return NO (rejecting the certificate) if called.
 @param certInfo NSString containing information about the certificate.
 @return YES to accept the certificate, NO to reject the certificate.
 */
