...
@private
	...
	//
	SUPLoginCertificate *_loginCertificate;
	
	//Set this property to enable authentication by username and password.
	SUPLoginCredentials *_loginCredentials;
	...
	NSString* _securityConfiguration;
	...
	SUPStringProperties *_httpHeaders;
    SUPStringProperties *_httpCookies;

    SUPLoginCredentials *_httpCredentials;
...
/*!
 ...
 @discussion
 */
@property(readwrite, copy, nonatomic) SUPLoginCredentials *loginCredentials;
/*!
 @property
