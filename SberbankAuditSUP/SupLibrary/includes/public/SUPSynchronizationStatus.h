...
typedef enum
{
    ...
    SUPSynchronizationStatus_CANCELED = 9
...
/*!
 @method
 @abstract  Returns the synchronization status for ASYNC_REPLAY_UPLOADED.
 @result An int describing the synchronization status.
 @discussion
 */
+ (SUPSynchronizationStatusType)ASYNC_REPLAY_UPLOADED;
/*!
 @method
 @abstract  Returns the synchronization status for ASYNC_REPLAY_COMPLETED.
 @result An int describing the synchronization status.
 @discussion
 */
+ (SUPSynchronizationStatusType)ASYNC_REPLAY_COMPLETED;
/*!
 @method
 @abstract  Returns the synchronization status for STARTING_ON_NOTIFICATION.
 @result An int describing the synchronization status.
 @discussion
 */
+ (SUPSynchronizationStatusType)STARTING_ON_NOTIFICATION;
/*!
 @method
 @abstract  Returns the synchronization status for CANCELED.
 @result An int describing the synchronization status.
 @discussion
 */
+ (SUPSynchronizationStatusType)CANCELED;
@end
