...
/*!
 @function
 @abstract   registers application if not registered already, otherwise SUPPersistenceException. once registered, start connection
 @discussion Equivalent to calling registerApplication:0. 
 @result   
 */
...
/*!
 @function
 @abstract   Start the connection for this application.
 @discussion Equivalent to calling startConnection:0. 
 @result   
 */
...
/*!
 @function
 @abstract   Stop the connection for this application.
 @discussion Equivalent to calling stopConnection:0. 
 @result   
 */
- (void)stopConnection;
...
/*!
 @function
 @abstract   Delete the registration for this application, and stop the connection. 
 @discussion Equivalent to calling unregisterApplication:0. 
 @result   
 */
...
/*!
 @function
 @abstract Clear application state
 @discussion This completely clears the application and messaging layer states, and can be used if needed if the client is using auto registration.  If this call is needed, it should only be called after the application is unregistered.  After calling this API, the SUPApplication will be in an uninitialized state and the application ID and other properties must be set before attempting to register with a server again.
 */
